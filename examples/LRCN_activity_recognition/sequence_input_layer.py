...
RGB_frames = '/home/yanyichao/data/cub_org/train_filter_new/'
test_frames = 16 
train_frames = 16
test_buffer = 3
train_buffer = 24
...
class videoRead(caffe.Layer):
  ...
  def initialize(self):
    ...
    self.video_list = '/home/yanyichao/data/cub_org/list/train_ss_new/train_lstm.txt'
  ...
  def setup(self, bottom, top):
    ...
    for ix, line in enumerate(f_lines):
      ...
      video_dict[video]['frames'] = frames[0][0:-9] + '__%04d.jpg'
      #video_dict[video]['reshape'] = (240,320)
      #video_dict[video]['crop'] = (227, 227)
      video_dict[video]['reshape'] = (228,228)
