...
#RGB_frames = '/media/yanyichao/3d5e3ed1-4752-4425-a2b4-7b8bf902f71e/re-id/prid/prid_lids/'
fea_path = '/media/yanyichao/5A487B64487B3DB7/re_id/prid/fea/lbp_color/'
test_frames = 10
train_frames = 10
test_buffer = 1
train_buffer = 8
...
class sequenceGeneratorVideo(object):
  ...
  def __call__(self):
    ...
    for i in idx_list:
      ...
      #color_fea_r.extend(tmp_rf_score.transpose())
...
class videoRead(caffe.Layer):
  ...
  def setup(self, bottom, top):
    ...
    #self.top_names = ['data', 'label','clip_markers', 'color_fea']
